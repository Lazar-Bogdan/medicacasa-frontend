...
export default (() => {
  ...
  async function handleAddClient(){
    ...
    const response = await UserService.addUser(username,email,Password,1011,age,"https://mydoctorbucket.s3.eu-central-1.amazonaws.com/profilePhotos/" + img.name,uid,img.name);
    if(response){
      alert("user created");
