...
var _allowedReactEls = _interopRequireDefault(require("./allowed-reactEls"));

var _reactElToCodeItem = _interopRequireDefault(require("./reactEl-to-codeItem"));

var _codeItemToDom = _interopRequireDefault(require("./codeItem-to-dom"));

var _codeItemToReactEl = _interopRequireDefault(require("./codeItem-to-reactEl"));

var _codeItemsToRawHtmlBody = _interopRequireDefault(require("./codeItems-to-rawHtmlBody"));
...
function getComponents() {
  var exported = (0, _toConsumableArray2["default"])(CODE_ITEMS);
  CODE_ITEMS = [];
  return exported.reduce(function (acc, _ref) {
    var rawKey = _ref.rawKey,
        codeItem = _ref.codeItem;
    var reactEl = (0, _codeItemToReactEl["default"])(rawKey, codeItem);
...
function insertItemsToDom(items) {
  ...
  Object.entries(places).forEach(function (_ref2) {
    ...
    var _selectorPosition$pla = (0, _slicedToArray2["default"])(selectorPosition[place], 2),
    ...
    try {
      if (position === 'afterbegin') {
        el.prepend.apply(el, (0, _toConsumableArray2["default"])(elements));
      } else if (position === 'beforeend') {
        el.append.apply(el, (0, _toConsumableArray2["default"])(elements));
      } else {
        el.append.apply(el, (0, _toConsumableArray2["default"])(elements));
      }
    } catch (error) {}
...
function useRawChildrenSSR(children) {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      if (!(0, _allowedReactEls["default"])(reactEl)) {
        console.error('Element is not allowed in RawHtml', reactEl);
        continue;
      }

      var _reactElementToCodeIt = (0, _reactElToCodeItem["default"])(reactEl),
          _reactElementToCodeIt2 = (0, _slicedToArray2["default"])(_reactElementToCodeIt, 2),
  ...
  _react["default"].useEffect(function () {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        var _reactElementToCodeIt3 = (0, _reactElToCodeItem["default"])(reactEl),
            _reactElementToCodeIt4 = (0, _slicedToArray2["default"])(_reactElementToCodeIt3, 2),
            rawKey = _reactElementToCodeIt4[0],
            codeItem = _reactElementToCodeIt4[1];

        var el = (0, _codeItemToDom["default"])(rawKey, codeItem);
        codeItems.push({
          rawKey: rawKey,
          codeItem: codeItem,
          el: el
...
RawHtml.codeItemsToRawHtmlBody = _codeItemsToRawHtmlBody["default"];