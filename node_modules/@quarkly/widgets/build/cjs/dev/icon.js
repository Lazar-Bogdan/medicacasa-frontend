...
var _commonProps = require("../prod/common-props");
...
var Wrapper = function Wrapper(_ref) {
  var _ref$icon = _ref.icon,
      ...
      rest = (0, _objectWithoutProperties2["default"])(_ref, ["icon", "category", "children"]);
  ...
  var setIcon = (0, _react.useCallback)(function (icon) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var loader = _utils["default"].getIcons(category);
  ...
  return /*#__PURE__*/_react["default"].createElement(_prod.Icon, (0, _extends2["default"])({}, rest, {
    icon: iconRef.current
  }));
};

var IconWrapper = (0, _atomize["default"])(Wrapper)({
  name: "Icon",
  effects: {
    hover: ":hover",
  ...
  propInfo: _objectSpread(_objectSpread({
    size: {
      control: "input",
      transformer: "pixel",
      category: "Main"
...
}, _objectSpread(_objectSpread({}, _prod.Icon.defaultProps), _commonProps.pointerEventsCategoryBaseDefaults));
